...
local highlight_groups = {
	...
	Vimwikigreen = { fg = green },
	Vimwikidefault = { bg = orange },
	Vimwikigray = { fg = gray },
	Vimwikiyellow = { fg = yellow },
	Vimwikiborange = { bg = orange },
	Vimwikibgray = { bg = gray },
	Vimwikibgreen = { bg = green },
	Vimwikired = { fg = red },
	Vimwikiorange = { fg = orange },
	Vimwikibpurple = { bg = magenta },
	Vimwikipurple = { fg = magenta },
	Vimwikiblue = { fg = blue },
	Vimwikibblue = { bg = blue },
	Vimwikibred = { bg = red },
	Vimwikibyellow = { bg = yellow },
	VimwikiMarkTag = { fg = black, bg = yellow },
	VimwikiBold = { style = "bold" },
	VimwikiItalic = { style = "italic" },
	VimwikiUnderline = { style = "underline" },
	VimwikiDelText = { style = "strikethrough" },
	VimwikiHeader1 = { fg = red, style = "bold" },
	VimwikiHeader2 = { fg = green, style = "bold" },
	VimwikiHeader3 = { fg = blue, style = "bold" },
	VimwikiHeader4 = { fg = magenta, style = "bold" },
	VimwikiHeader5 = { fg = pink, style = "bold" },
	VimwikiHeader6 = { fg = pinkt_light, style = "bold" },
	VimwikiItalicUnderline = { style = { "underline", "italic" } },
	VimwikiBoldItalicUnderline = { style = { "underline", "italic", "bold" } },
